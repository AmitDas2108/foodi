    ...
    <div>
      <footer className={`footer xl:px-24 py-10 px-4 text-base-content ${
        ...
        <nav>
          ...
          <a className="link link-hover">amitdasismyname@gmail.com</a>
          <a className="link link-hover">8240321349</a>
      ...
      <footer  className={`footer items-center xl:px-24 px-4 py-4 mt-2 ${
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a href="https://www.facebook.com/profile.php?id=100015635883181">
            <svg
